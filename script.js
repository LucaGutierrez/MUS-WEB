...
function mostrarMenuMobile() {
    ...
    fondoMenuMobile.classList.add("activo");
...
function ocultarMenuMobile() {
    ...
    fondoMenuMobile.classList.remove("activo");
...
abrirMenuMobile?.addEventListener(
    "click",
    mostrarMenuMobile
);


cerrarMenuMobile?.addEventListener(
    "click",
    ocultarMenuMobile
);


fondoMenuMobile?.addEventListener(
    "click",
    ocultarMenuMobile
);


/* DESPLEGAR HOMBRE Y MUJER */

document
    .querySelectorAll(".boton-submenu-mobile")
    .forEach(boton => {
